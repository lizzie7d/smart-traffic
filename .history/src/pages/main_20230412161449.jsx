...
import ksh35 from '../img/images/ksh35.png';
...
import "./style.css";
import Echartstest from '../component/charts/areaChart';
const MainPage = () => {
        ...
        <div className="main-container">
                    ...
                    <div className="visual_chart sfzcll">
                        ...
                        <div className="sfzcll_pos_box">
                            <div className="sfzcll_box">
                                ...
                                <img className="sfzcll_bkJk" src="../src/img/images/ksh34.png" />
                                <img className="sfzcll_bkJk" src="../src/img/images/ksh34.png" />
                                <label><img src={{ ksh35 }} />公路运输</label>
                            ...
                            <div className="sfzcll_box">
                                <img className="sfzcll_bkJk" src={{ ksh34 }} />
                                <img className="sfzcll_bkJk" src={{ ksh34 }} />
                                <img className="sfzcll_bkJk" src={{ ksh34 }} />
                                <img className="sfzcll_bkJk" src={{ ksh34 }} />
            ...
            <div className="visual_con">
                ...
                <div className="visual_conBot">
                    ...
                    <img className="visual_conBot_2" src={{ ksh43 }} />
                    <img className="visual_conBot_3" src={{ ksh44 }} />
                    <img className="visual_conBot_4" src={{ ksh45 }} />
